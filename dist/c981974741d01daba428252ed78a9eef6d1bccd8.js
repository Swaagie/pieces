...
Component.prototype.configure = function configure(name, data, state, roots) {
  ...
  component.css = collection.array(data.css);     // CSS for the Page.
  component.js = collection.array(data.js);       // Dependencies for the page.

  this.render()
}

Component.prototype.load = function () {
  async.each(this.js, function download(url, next) {
    console.log(url);
...
},{"async-asset":3,"eventemitter3":7}],3:[function(require,module,exports){
'use strict';
...
},{"async-script":4,"floppy":6}],4:[function(require,module,exports){
'use strict';
...
},{"one-time":5}],5:[function(require,module,exports){
'use strict';
...
},{"./emptyFunction":114,"_process":1}],"reacts":[function(require,module,exports){
'use strict';
...
Reacts.prototype.arrive = function arrive(name, data, state) {
  ...
  component.configure(name, data || {}, state, roots);
...
},{"./component":2,"eventemitter3":7,"react":"react"}],"react":[function(require,module,exports){
